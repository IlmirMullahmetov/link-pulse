...
export const DeleteModalContent = ({ site, onClose }: DeleteModalContentProps) => {
    ...
    return (
        <div className="flex flex-col gap-6 relative text-center">
            ...
            <div className="text-white/60 font-medium flex flex-col gap-1">
                <span>Вы уверены, что хотите удалить ресурс <span className="text-(--color-primary)">{site.name}</span>?</span>
